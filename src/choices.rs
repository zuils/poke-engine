...
pub struct Choice {
    ...
    pub is_z_move: bool,
    pub z_crit_ratio: i8,
    pub z_fixed_damage_fraction: Option<f32>,
    pub z_sets_psychic_terrain: bool,
    pub z_clears_terrain: bool,
...
impl Default for Choice {
    fn default() -> Choice {
        Choice {
            ...
            is_z_move: false,
            z_crit_ratio: 0,
            z_fixed_damage_fraction: None,
            z_sets_psychic_terrain: false,
            z_clears_terrain: false,
            boost: None,
            priority: 0,
            flags: Flags {
                ..Default::default()
